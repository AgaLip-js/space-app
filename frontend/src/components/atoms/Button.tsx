...
`;
const Button: React.FC<ButtonProps> = ({ children, type, disabled = false, onClick }) => <StyledButton type={type} disabled={disabled || false} onClick={onClick}>{children}</StyledButton>;
