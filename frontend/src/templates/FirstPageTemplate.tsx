        ...
        <StyledLeftContent>
          ...
          <StyledTextWrapper>
            ...
            <p>
              ...
              <strong>private</strong>
              {' '}
              room you will find a calendar with a scheduling and notification system. You have at your disposal your own library with sections such as Books, Music, Movies, Recipes.
            </p>
            <p>
              In the
              <strong>community</strong>
              {' '}
              section, you have the ability to create posts, share your own ideas and libraries.
            </p>
            <p>
